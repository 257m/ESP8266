...
inline unsigned int count_digits(int64_t n, uint8_t base)
{
...
inline unsigned int ucount_digits(uint64_t n, uint8_t base)
{
  unsigned int digits = 1;
  while (n /= base)
    digits++;
...
(char* buffer, unsigned int buffer_size,
 unsigned int bi, int n, uint8_t base)
{
...
(char* buffer, unsigned int buffer_size,
 unsigned int bi, unsigned int n, uint8_t base)
{
...
(char* buffer, unsigned int buffer_size,
 unsigned int bi, long n, uint8_t base)
{
  unsigned int digits = count_digits(n, base) + (n < 0);
  if (bi+digits >= buffer_size)
    return digits;
...
(char* buffer, unsigned int buffer_size,
 unsigned int bi, unsigned long n, uint8_t base)
{
  unsigned int digits = ucount_digits(n, base);
  if (bi+digits >= buffer_size)
    return digits;
...
char* str_find_char(char* str, unsigned int size, char to_find)
{
